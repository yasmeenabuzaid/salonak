  @extends('layouts.dashboard_master')
        ...
        <div class="container">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h3><i class="fas fa-user-tie me-2"></i> Owners</h3>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($user->usertype === 'user')
                                            <label class="badge" style="background-color: rgb(149, 77, 42); color: white;">Customer</label>
                                        ...
                                        @elseif($user->usertype === 'owner')
                                            <label class="badge" style="background-color: rgb(107, 36, 77); color: white;">Owner</label>
                                        @elseif($user->usertype === 'super_admin')
                                            <label class="badge" style="background-color: rgb(34, 123, 34); color: white;">Super Admin</label>
                                        @endif
                                    </td>
                                    <td>{{ $user->email }}</td>
                                    <td>
